...
local STORAGE = HOME_DIR .. '/.cache/todo-widget/todos.json'
...
local add_button = wibox.widget {
    {
        {
            image = '/usr/share/icons/Papirus/symbolic/actions/list-add-symbolic.svg',
            resize = false,
            widget = wibox.widget.imagebox
        },
        top = 11,
...
local function worker(args)
    ...
    local icon = args.icon or '/usr/share/icons/Papirus/symbolic/status/checkbox-checked-symbolic.svg'
    ...
    function update_widget(stdout)
        ...
        for i, todo_item in ipairs(result.todo_items) do
            ...
            local trash_button = wibox.widget {
                {
                    {    image = '/usr/share/icons/Papirus/symbolic/actions/window-close-symbolic.svg',
                        resize = false,
                        widget = wibox.widget.imagebox
                    },
                    margins = 5,
